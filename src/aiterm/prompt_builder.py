...
- Set "needs_context" to true if you need system information to provide better suggestions
- Include "context_commands" only if needs_context is true
- These should be safe info-gathering commands like pwd, ls, cat, echo
...
def build_structured_prompt(user_input: str, 
    ...
    if available_commands:
        commands_str = ', '.join(available_commands[:100])  # Limit for context
